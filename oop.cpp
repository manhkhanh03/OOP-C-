    ...
    public:
        ...
        long tinh_tienlai(int thang){
            if(thang >= Ki_han){
                ...
                tongtienlai += Tien_lai;
                return Tien_lai;
            }else return Tien_lai = 0;
        }
        float tinh_laisuat(int thang){
            if(thang >= Ki_han){
                tong_laisuat = Lai_suat * thang;
                return tong_laisuat;
            }else return tong_laisuat = 0;
        }
        long tong_tl(){
            return tongtienlai;
        }
    ...
    public:
        ...
        void out(ofstream &outfile){
           outfile << "_________________________________________________________________________________________________________________________________________________________________________________________________________" << endl;
            outfile << "| " << setw(11) << " Ho ten " << setw(6) << " |  " << setw(5) << " MKH  | " << setw(11) << " CMND  " << setw(20) << " | Ngay lap so  | Ki han | " << setw(5) << " Ten ngan hang  | " << setw(15) << " Dia chi " << setw(5) << " | " << setw(15) << " Email " << setw(9) << " | " << setw(10) << " Ma so thue  | " << setw(10) << " SDT " << setw(10) << " | " << setw(5) << " Lai suat " <<  " | "  << setw(7) << " So du " << setw(6) << " | " << setw(7) << " Tien lai " << setw(4) << " | " << endl;
            outfile << "_________________________________________________________________________________________________________________________________________________________________________________________________________" << endl;
        }
        void output(ofstream &outfile){
            if(b == 1){
        ...
        void outt(){
            ...
            cout << "| " << setw(11) << " Ho ten " << setw(6) << " |  " << setw(5) << " MKH  | " << setw(11) << " CMND  " << setw(20) << " | Ngay lap so  | Ki han | " << setw(5) << " Ten ngan hang  | " << setw(15) << " Dia chi " << setw(5) << " | " << setw(15) << " Email " << setw(9) << " | " << setw(10) << " Ma so thue  | " << setw(10) << " SDT " << setw(10) << " | " << setw(5) << " Lai suat " <<  " | "  << setw(7) << " So du " << setw(6) << " | " << setw(7) << " Tien lai " << setw(4) << " | " << endl;
            cout << "_________________________________________________________________________________________________________________________________________________________________________________________________________" << endl;
        }
        void out_put(){
            if(b == 1){
        ...
        void Chuc_nang(){
            ...
            if(x == 1){
                long Tien_rut;
                nhaplaitienrut : cout << "Nhap so tien muon rut: ", cin >> Tien_rut;
                if(b == 1){
...
int main(){
    ...
    for(int i = 0; i < a; i++)
        tongtl += s[i] -> tong_tl();
    outfile << "| " << setw(13) << " Tong" << " | " << setw(9) << " | " << setw(14) << " | " << setw(15) << " | " << setw(9) << "| " << setw(18) << " | " << setw(20) << " | " << setw(24) << " | " << setw(15) << " | " << setw(20) << " | " << setw(13)  << " | " << setw(13)  << " | " << setw(11) << tongtl << " | " << endl;
    outfile << "---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------" << endl;
    int z = 1, Sdt = 1, Nm = 1, Cm = 1;
    long tong_tl = 0;
    string sdt_cantim, name_cantim, cmnd_cantim;
    nhaplailenh : cerr << "Nhap so can thuc thi:\n1) Tim kiem bang sdt!\n2) Tim kiem bang ten khach hang!\n3) Tim kiem bang CMND!\n4) Xem thong tin toan bo so! " << endl;
    cout << "Moi nhap: ", std :: cin >> z;
    if(z == 1){
        nhapsdt : cout << "Moi nhap sdt can tim: ";
        cin >> sdt_cantim;
    }
    if(z == 2){
        nhaptenkh : cout << "Moi nhap ten khach hang can tim: ";
        cin >> name_cantim;
    }
    if(z == 3){
        nhapemailkh : cout << "Moi nhap CMND khach hang can tim: ";
        cin >> cmnd_cantim;
    }
    if(z == 4){
        s[0] -> outt();
        ...
        for(int i = 0; i < a; i++)
            tong_tl += s[i] -> tong_tl();
        cout << "| " << setw(13) << " Tong" << " | " << setw(9) << " | " << setw(14) << " | " << setw(15) << " | " << setw(9) << "| " << setw(18) << " | " << setw(20) << " | " << setw(24) << " | " << setw(15) << " | " << setw(20) << " | " << setw(13)  << " | " << setw(13)  << " | " << setw(11) << tong_tl - tongtl << " | " << endl;
        cout << "---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------" << endl;
    }
    for(int i = 0; i < a; i++){
    ...
    if(Sdt > a){
        ...
        if(so_dt == 1) goto nhapsdt;
    }
    if(Nm > a){
        int name_kh;
        Nm = 1;
        cout << "Khong tim thay ten khach hang can tim!\nBan co muon nhap lai(0/1): ", cin >> name_kh;
        if(name_kh == 1) goto nhaptenkh;
    }
    if(Cm > a){
        int Cmnd_kh;
        Cm = 1;
        cout << "Khong tim thay email khach hang can tim!\nBan co muon nhap lai(0/1): ", cin >> Cmnd_kh;
        if(Cmnd_kh == 1) goto nhapemailkh;
    }
    int o;
    cout << "Ban co muon thuc hien lai(0/1): "; cin >> o;
    if(o == 1) goto nhaplailenh;
    outfile << "================================================================== Sau khi thuc hien cac thao tac!======================================================================" << endl;
    s[0] -> out(outfile);
    for(int i = 0; i < a; i++){
        s[i] -> output(outfile);
    }
    outfile << "| " << setw(13) << " Tong" << " | " << setw(9) << " | " << setw(14) << " | " << setw(15) << " | " << setw(9) << "| " << setw(18) << " | " << setw(20) << " | " << setw(24) << " | " << setw(15) << " | " << setw(20) << " | " << setw(13)  << " | " << setw(13)  << " | " << setw(11) << tong_tl - tongtl << " | " << endl;
    outfile << "---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------" << endl;
}